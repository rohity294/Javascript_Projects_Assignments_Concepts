$( document ).ready(function() {
    ...
    $('#mydiv').html(mymontharray[month]+"&nbsp"+year);                  
...
{ 
   ...
   //Here we have passed 2019,July,32 and we get dt2=1st August
   //temp=32-1st August=31st July

   console.log("check for last date of month:"+temp);
    return temp;
